...
.lsm-visual .lsm-file[data-kind="wal"] {
...
<div class="gc-visual lsm-visual" role="img" aria-label="LSM Tree의 쓰기 경로와 계층 구조">
  <div class="gc-visual__header">
    ...
    <span>디스크의 랜덤 수정 대신 디스크 WAL append, MemTable 정렬, SSTable flush, background compaction으로 흘러간다.</span>
  </div>
  <div class="lsm-flow">
    <div class="lsm-step"><b>PUT</b><span>쓰기 요청</span></div>
    <div class="lsm-step"><b>WAL</b><span>디스크 append</span></div>
  ...
  <div class="lsm-layers">
    <div class="lsm-card">
      <b class="lsm-card-title">로그 + 메모리</b>
      <div class="lsm-level">
        <b>Disk</b>
        <div class="lsm-run" data-count="1"><span class="lsm-file" data-kind="wal">WAL file<br>append</span></div>
      </div>
      <div class="lsm-level">
        <b>Mem</b>
...
- `WAL` 또는 commit log: 장애 복구를 위한 디스크의 append-only 로그다.
...
- [Apache HBase Reference Guide - Write Ahead Log](https://hbase.apache.org/book.html#wal)
