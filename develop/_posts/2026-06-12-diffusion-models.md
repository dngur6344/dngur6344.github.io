...
description: >
  DDPM의 정방향/역방향 과정, 노이즈 예측 손실, score 관점, classifier-free guidance, Latent Diffusion과 VAE의 역할을 정리합니다.
...
이 글은 Notion의 Diffusion, 이미지 분포, Stable Diffusion, VAE/Latent 관련 문서들을 하나로 묶어 정리한 글이다. 직관은 포근하게 잡되, 수식과 용어는 가능한 정확하게 두었다.
